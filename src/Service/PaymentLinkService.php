...
class PaymentLinkService
{
    ...
    public function generatePaymentLink($order, $successUrl, $cancelUrl, Context $context, $api = false, string $salesChannelId = ''): string
    {
        ...
        $surchargeAmount = $this->resolveOrderSurchargeAmount($order);
    ...
    public function sendEmail(string $link, OrderEntity $order, string $salesChannelId, Context $context): void
    {
        $data = new DataBag();
    ...
    private function resolveOrderSurchargeAmount(OrderEntity $order): float
    {
        ...
        $amount = (float) ($surcharge['amount'] ?? 0.0);
