...
class OrderService
{
    ...
    public function extractLVL2And3DataFromCart(Cart $cart, SalesChannelContext $context): array
    {
        ...
        return $this->extractLVL2And3Data($cart->getLineItems(), $cartPrice, $customer, $shippingAddress, $shippingCost);
    }

    public function extractLVL2And3DataFromOrder(OrderEntity $order): array
    {
        ...
        return $this->extractLVL2And3Data($order->getLineItems(), $cartPrice, $customer, $shippingAddress, $shippingCost);
    }

    private function extractLVL2And3Data($lineItems, $totalPrice, $customer, $shippingAddress, $shippingCost): array
    {
        $items = [];
