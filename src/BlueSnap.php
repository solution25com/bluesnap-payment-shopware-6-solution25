...
class BlueSnap extends Plugin
{
  ...
  private function dropBlueSnapTables(): void
  {
    ...
    /** @lang text */ 'DROP TABLE IF EXISTS
    ...
    // Delete migrations
    $connection->executeStatement(
    /** @lang text */ 'DELETE FROM `migration` WHERE `class` LIKE :blue_snap OR `class` LIKE :vaulted_shopper;',
      [
        'blue_snap' => '%BlueSnap%',
    ...
    /** @lang text */ 'SELECT `id` FROM `mail_template_type` WHERE `technical_name` LIKE :payment_link',
      [
    ...
    /** @lang text */ 'SELECT `id` FROM `mail_template` WHERE `mail_template_type_id` = :template_type_id',
      [
    ...
    $connection->executeStatement(
    /** @lang text */ 'DELETE FROM `mail_template_translation` WHERE `mail_template_id` = :template_id',
      [
    ...
    // Delete Type
    $connection->executeStatement(
    /** @lang text */ 'DELETE FROM `mail_template` WHERE `mail_template_type_id` = :template_type_id',
      [
        'template_type_id' => $mailTypeId,
      ]
    );
    ...
    $connection->executeStatement(
    /** @lang text */ 'DELETE FROM `mail_template_type` WHERE `technical_name` LIKE :payment_link',
      [
        'payment_link' => '%admin.payment.link%',
      ]
    );
    ...
    $connection->executeStatement(
    /** @lang text */ 'DELETE FROM `mail_template_type_translation` WHERE `name` LIKE :payment_name',
      [
