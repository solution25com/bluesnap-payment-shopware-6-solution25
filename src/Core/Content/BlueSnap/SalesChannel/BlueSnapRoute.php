...
class BlueSnapRoute extends AbstractBlueSnapRoute
{
  ...
  public
  function getDecorated(): AbstractBlueSnapRoute
  {
  ...
  public function capture(Request $request, SalesChannelContext $context): BlueSnapApiResponse
  {
    ...
    $customerEntity = $context->getCustomer()->getDefaultBillingAddress();
    $customerCity = $customerEntity->getCity();
    $customerZipCode = $customerEntity->getZipcode();
    $customerCountry = $customerEntity->getCountry()->getIso();
    ...
    $body = [
      ...
      "cardHolderInfo" => [
        ...
        "zip" => $customerZipCode,
        "country" => strtolower($customerCountry),
        "city" => $customerCity,
      ],
