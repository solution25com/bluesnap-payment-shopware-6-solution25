...
Shopware.Component.override('sw-order-detail-general', {
    ...
    methods: {
        ...
        getTaxSummaryLabel(calculatedTax) {
            if (calculatedTax?.label === 'surcharge') {
                return this.$tc('Bluesnap.order.paymentSurcharge');
            }

            return this.$tc('sw-order.detailBase.summaryLabelTaxes', { taxRate: calculatedTax.taxRate }, 1);
        }
    }
});
